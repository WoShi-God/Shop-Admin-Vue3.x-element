...
.login-container {
  ...
  background-image: radial-gradient(closest-side, rgb(202, 251, 236), rgba(255, 154, 134, 0)), radial-gradient(closest-side, rgb(252, 211, 211), rgba(255, 126, 212, 0)), radial-gradient(closest-side, rgb(230, 249, 187), rgba(254, 234, 131, 0)), radial-gradient(closest-side, rgb(197, 248, 241), rgba(170, 142, 245, 0)), radial-gradient(closest-side, rgb(224, 220, 251), rgba(248, 192, 147, 0));
...
.right .right-content .title {
  text-align: center;
  letter-spacing: 3px;
  color: #22446e !important;
  font-size: 40px !important;
  text-shadow:4px 4px rgba(170, 142, 245, .3) ;
